package com.example.sharedpreferences.changelanguage;
...
import com.example.sharedpreferences.databinding.ItemLanguageBinding;
import com.example.sharedpreferences.model.Language;
import com.example.sharedpreferences.utils.LanguageUtils;
...
public class LanguageAdapter extends RecyclerView.Adapter<LanguageAdapter.LanguageHolder> {
    ...
    private ItemClickListenr<Language> mListener;
    ...
    public void setListener(ItemClickListenr<Language> listener) {
        mListener = listener;
    }
